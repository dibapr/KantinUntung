...
<body class="dark:bg-slate-800">
    <div class="back flex items-center">
        ...
        <h1 class="text-2xl font-medium dark:text-gray-300">Edit Menu</h1>
    </div>
    <div class="container mx-auto px-10">
        <div class="form">
            <form method="POST" enctype="multipart/form-data">             
                ...
                <label for="gambarlama" class="dark:text-gray-300">Gambar Lama:</label>
                <img class="mb-6" width="200px" height="200px" id="gambarlama" src="assets/<?= $menu["image"]; ?>">
                
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="user_avatar">Upload file</label>
                <input name="gambar" class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file" autocomplete="off">
                ...
                <div class="mb-6">
                    ...
                    <input name="menu_name" value="<?= $menu["menu_name"] ?>" type="text" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" value="<?= $menu["price"] ?>" name="price" id="harga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
