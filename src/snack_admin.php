...
<body class="bg-gray-200 dark:bg-slate-800">
    ...
    <div class="flex flex-row items-start">
        <aside class="w-64 NoSidebar" id="sidebar" aria-label="Sidebar">
            <div class="overflow-y-auto lg:fixed dark:bg-gray-900 bg-mid-green h-screen py-4 px-3 w-64">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="admin.php" class="flex items-center p-2 text-base font-normal text-slate-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <a href="makanan_admin.php" class="flex items-center p-2 text-base font-normal text-slate-700 dark:hover:bg-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100">
                    ...
                    <li>
                        <a href="minuman_admin.php" class="flex items-center p-2 text-base font-normal text-slate-700 dark:text-gray-300 rounded hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <a href="snack_admin.php" class="flex items-center p-2 text-base font-normal text-slate-700 dark:text-gray-300 rounded bg-gray-100 dark:bg-gray-700">
        ...
        <div class="panel lg:m-12 m-6 mt-24 mx-auto">
            <h1 class="text-3xl font-semibold mb-5 text-slate-800 dark:text-slate-300">Snack</h1>
            ...
            <div class="snack-wrapper mt-5 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-5">
                ...
                <div class="card rounded-lg bg-white dark:bg-gray-900 dark:text-slate-300 grid py-5 px-10 gap-3">
                    <img class="rounded-md" width="200px" height="200px" src="assets/<?= $snack["image"]; ?>" alt="">
